...
const PricingPage = () => {
  ...
  const section2Config = {
    // Mobile Props
    scrollY,
    animateRange: [PHASE_2_END, PHASE_3_END],
    scrollRange: [PHASE_2_END, PHASE_3_END],
    scrollOutput: ['150%', '30%'],
    // Desktop Props
  ...
  return (
    <div className="bg-[#0a0a0a] min-h-screen overflow-x-hidden font-sans selection:bg-[#FF9933] selection:text-black relative">
      ...
      <div className="fixed top-8 left-0 w-full text-center z-50 pointer-events-none mix-blend-overlay">
        <p className="text-white/50 text-xs uppercase tracking-[0.2em]">Scroll to Explore Pricing</p>
